...
export default function Home() {
  const { spaces, hours, bookings } = useApp()
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      {/* Hero */}
      <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl px-6 py-12 mb-10 text-white text-center">
        <div className="flex justify-center mb-4">
          <Building2 className="w-12 h-12 opacity-80" />
        </div>
        <h1 className="text-3xl sm:text-4xl font-bold mb-3">Book Your Workspace</h1>
        <p className="text-blue-100 text-lg max-w-xl mx-auto">
          Reserve meeting rooms and hot desks in seconds. Stay productive, stay organized.
        </p>
        {isTodayClosed ? (
